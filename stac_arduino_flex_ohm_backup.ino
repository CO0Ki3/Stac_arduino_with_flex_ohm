...
void loop() {
  ...
  float flexR_T_fixed = flexR_T - 700;
  float flexR_M_fixed = flexR_M - 300;
  float flexR_B_fixed = flexR_B - 100;
  Serial.print("X : ");
  Serial.println(x);
  Serial.print("Y : ");
  Serial.println(y);
  ...
  Serial.println("Resistance: " + String(flexR_T_fixed) + " ohms"); // Left Value
  Serial.println("Resistance: " + String(flexR_B_fixed) + " ohms"); // Middle Valuex  
  Serial.println("Resistance: " + String(flexR_M_fixed) + " ohms"); // Right Value
